...
const Header = () => {
  return (
    <div className='h-[50vw] sm:h-[45vw] md:h-[34vw] my-7 mx-auto bg-[url("/Contact_Header.png")] bg-no-repeat bg-cover bg-[length:100%_160%] relative rounded-lg overflow-hidden shadow-md header-container'>
